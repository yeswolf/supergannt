...
- Use an in-process/out-of-process **converter** (Java jar) runnable on the app’s server side inside Electron/Docker/Node hosts.
...
- Electron packaged resources must include jar + blank template + UI.
